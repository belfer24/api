...
export class OutlookHelper {
  ...
  public async Connect(refreshToken: string): IOutlookHelper.Methods.Connect.Response {
      try {
  ...
  public async Available(refreshToken: string): IOutlookHelper.Methods.Available.Response {
      try {
  ...
  public async Send(letter): IOutlookHelper.Methods.Send.Response {
      try {
          const { BodyType } = IOutlookHelper.Graph.Property;
